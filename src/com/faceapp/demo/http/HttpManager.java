...
//	private static final String BOUNDARY = "7cd4a6d158c";
	 ...
	 */
	public static String openUrl(String url, String method, HttpParameters params, String file) throws HttpException {
		String result = "";
		try {
			...
			if (method.equals(HTTPMETHOD_GET)) {
				...
				if (!TextUtils.isEmpty(file)) {
					...
					imageContentToUpload(bos, "img", file);
				} else {
...
//			}
	...
	private static void imageContentToUpload(OutputStream out,String imgkey , String imgpath) throws HttpException {
		if(imgpath==null){
		    return;
		}
		...
		temp.append(MP_BOUNDARY).append("\r\n");
		//
		temp.append("Content-Disposition: form-data; name=\""+ imgkey + "\"; filename=\"")
		//temp.append("Content-Disposition: form-data; name=\"img\"; filename=\"")
